...
Revision ID: 6932e99173ae
Revises: 8e5deb67bd9f
Create Date: 2026-06-28 11:36:36.190413
"""
...
revision: str = '6932e99173ae'
down_revision: Union[str, None] = '8e5deb67bd9f'
...
def upgrade() -> None:
    ...
    op.add_column('fix_records', sa.Column('downstream_services_ids', postgresql.ARRAY(sa.UUID()), nullable=True))
    op.drop_column('fix_records', 'downstream_service_id')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('fix_records', sa.Column('downstream_service_id', postgresql.ARRAY(sa.UUID()), autoincrement=False, nullable=True))
